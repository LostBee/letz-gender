...
window.LetzGender.topics.push({
  ...
  words: [
    ...
    { word: "Gilet", article: "de", plural: "d'Gileten", gender: "m", definition: "vest / cardigan", audio: "audio/clothing/gilet1.m4a" },
    ...
    { word: "Mantel", article: "den", plural: "d'Mäntel", gender: "m", definition: "coat", audio: "audio/clothing/mantel1.m4a" },
    { word: "Anorak", article: "den", plural: "d'Anoraken", gender: "m", definition: "anorak", audio: "audio/clothing/anorak1.m4a" },
    { word: "Kostüm", article: "dat", plural: "d'Kostümer", gender: "n", definition: "suit", audio: "audio/clothing/kostum1.m4a" },
    { word: "Tailleur", article: "de", plural: "d'Tailleuren", gender: "m", definition: "women's suit", audio: "audio/clothing/tailleur1.m4a" },
    ...
    { word: "Jeansbox", article: "d'", plural: "d'Jeansboxen", gender: "f", definition: "jeans", audio: "audio/clothing/jeansbox1.m4a" },
    { word: "Joggingsbox", article: "d'", plural: "d'Joggingsboxen", gender: "f", definition: "jogging pants", audio: "audio/clothing/joggingsbox1.m4a" },
    { word: "Short", article: "d'", plural: "d'Shorten", gender: "f", definition: "shorts", audio: "audio/clothing/short1.m4a" },
    { word: "Bermudashort", article: "d'", plural: "d'Bermudashorten", gender: "f", definition: "Bermuda shorts", audio: "audio/clothing/bermudashort1.m4a" },
    ...
    { word: "Salopett", article: "d'", plural: "d'Salopetten", gender: "f", definition: "overalls / dungarees", audio: "audio/clothing/salopett1.m4a" },
    ...
    { word: "Stiwwel", article: "de", plural: "d'Stiwwelen", gender: "m", definition: "boot", audio: "audio/clothing/stiwwel1.m4a" },
    { word: "Sandal", article: "d'", plural: "d'Sandalen", gender: "f", definition: "sandal", audio: "audio/clothing/sandal1.m4a" },
    { word: "Schlapp", article: "d'", plural: "d'Schlappen", gender: "f", definition: "slipper", audio: "audio/clothing/schlapp1.m4a" },
    { word: "Turnschlapp", article: "d'", plural: "d'Turnschlappen", gender: "f", definition: "sneaker / gym shoe", audio: "audio/clothing/turnschlapp1.m4a" },
    { word: "Tallekeschong", article: "de", plural: "d'Tallekeschong", gender: "m", definition: "high heel shoe", audio: "audio/clothing/tallekeschong1.m4a" },
    ...
    { word: "Maillot", article: "de", plural: "d'Mailloten", gender: "m", definition: "swimsuit", audio: "audio/clothing/maillot1.m4a" },
    { word: "Schwammbox", article: "d'", plural: "d'Schwammboxen", gender: "f", definition: "swim trunks", audio: "audio/clothing/schwammbox1.m4a" },
    ...
    { word: "Kap", article: "d'", plural: "d'Kappen", gender: "f", definition: "cap", audio: "audio/clothing/kap1.m4a" },
    ...
    { word: "Foulard", article: "de", plural: "d'Foularden", gender: "m", definition: "scarf / headscarf", audio: "audio/clothing/foulard1.m4a" },
    { word: "Krawatt", article: "d'", plural: "d'Krawatten", gender: "f", definition: "necktie", audio: "audio/clothing/krawatt1.m4a" },
    { word: "Rimm", article: "de", plural: "d'Rimmer", gender: "m", definition: "belt", audio: "audio/clothing/rimm1.m4a" },
